namespace LabsLibrary
{
	...
	{
		public static bool RunApp(string inputTextFile = "INPUT.TXT")
		{
			var listOfUnsuitableTableNeighbors = new Dictionary<int, List<int>>();
			var firstLineOfInputFile = File.ReadLines(inputTextFile).First();
			...
			for (int i = 1; i <= 100; i++)
			{
				var line = File.ReadLines(inputTextFile).Skip(i).FirstOrDefault();
			...
			return itIsPossibleToOrganizeEvent;
		}

		private class VIPsOrganizer
		{
